...
public class NeaPredict2 {
	...
	public String toString() {
		return "NeaPredict [newsCode=" + newsCode + ", sentiment=" + sentiment + ", posRate=" + posRate + ", negRate=" + negRate + ", processTime=" + processTime + ", logTime="
				+ logTime + ", title=" + title + ", text=" + text.length() + ", result=" + result + ", classNameList=" + classNameList + ", companyNames=" + companyNames + "]";
	}
