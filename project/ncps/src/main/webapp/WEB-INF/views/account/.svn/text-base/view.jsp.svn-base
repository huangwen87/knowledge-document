...
<head>
	...
	<link rel="stylesheet" href="<c:url value="js/plugin/blueprint/screen.css" />" type="text/css" media="screen, projection">
	<link rel="stylesheet" href="<c:url value="js/plugin/blueprint/print.css" />" type="text/css" media="print">
	<!--[if lt IE 8]>
