        ...
        <div class="container-fluid">
				...
				<div class="row-fluid sortable">
				   	<div class="box span9">
						<div class="box-header well">
							<h2>
								<i class="icon-list-alt"></i>垃圾记录</h2>
							<div class="box-icon">
					...
					<div data-original-title="" class="box-header well">
						<h2><i class="icon-edit"></i> 垃圾添加</h2>
						<div class="box-icon">
						...
						<form class="form-vertical" id="searchForm" >
							<fieldset>
							  <div class="control-group">
								<label for="trash" class="control-label">垃圾样本</label>
								<div class="controls">				
								  <textarea id="trash" name= "trash" style="width: 96%; height: 200px;"></textarea>
								</div>
							  </div>
        	...
        	<script type="text/javascript">
        	   $(function(){
				...
				function init(){
						$("#gridTable").jqGrid({
							url:"ndr/sample/querytrash",
							datatype : "json",
			                height: 'auto',
			                autowidth: true,
			                colNames:[ '垃圾ID','垃圾文本','时间'],
			                colModel:[
			                          {name:'id',width:'50',index:'id'},             
			                          {name:'trash',width:'250',index:'trash'},                       
			                ...
			                loadComplete: function() {
								var delSettings = {
				                    ...
				                    url:"ndr/sample/delduplicateremovalsamplebyid",
				...
				function add(){
					$.ajax({
							url:"ndr/sample/addTrash?"+ $('#searchForm').serialize(),
							type:"GET",
							async:false,
