					...
					<div class="row-fluid sortable">
						<div class="box">
							<div class="box-header well">
								<h2>
									<i class="icon-list-alt"></i>新闻去重比例</h2>
								<div class="box-icon">
			...
			<script type="text/javascript">
				$(function() {
					...
					$('#container').highcharts('StockChart', {
						...
						tooltip: {
				            ...
				            formatter: function() {
				                    return '在'+
				                    Highcharts.dateFormat('%Y-%m-%d %H:%M:%S', this.x) +'<br/>去重比为'+
				...
				function getData() {
				          ...
				          setInterval(function(){
							 $.ajax({
								    	type: "POST",
										   url: "log/ratio/"+maxTimestamp,
										   async: false,
										   success: function(msg){
										   var jsonList2 = eval('(' + msg + ')');
										   var len2=jsonList2.length;
											 for (i = 0; i <len2; i++) {
								                    series.addPoint([jsonList2[i].timestamp, jsonList2[i].ratio], true, true);
								             }
