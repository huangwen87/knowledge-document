        ...
        <div class="container-fluid">
        	...
        	<script type="text/javascript">
			   ...
			   function getSelectData(){
				...
				function init(){
						$("#gridTable").jqGrid({
							url:"nea/posORneg/querynews?"+ $('#searchForm').serialize(),
							datatype : "json",
			                height: 'auto',
			                autowidth: true,
			                autoencode:true,
			                colNames:[ '新闻ID','标题','正负面','行业名称','机构','发布时间','处理时间'],
			                colModel:[
			        ...
			        function query(){
			        	...
			        	var data="nea/posORneg/querynews?"+ $('#searchForm').serialize();
			        ...
			        function queryContentById(rowId){
						...
						$( "#dialog p" ).empty();
						$.ajax({
							url:"nea/posORneg/querynewsbyid?id="+filterId,
							type:"GET",
							async:false,
							success:function(msg){
								$( "#dialog p" ).text(msg);
