        ...
        <div class="container-fluid">
						...
						<form class="form-vertical" id="searchForm" >
							<fieldset>
							  <div class="control-group">
								<label for="word" class="control-label">情感标题样本</label>
								<div class="controls">				
        	...
        	<script type="text/javascript">
        	   $(function(){
				...
				function init(){
						$("#gridTable").jqGrid({
							url:"ndr/sample/queryemotiontitle",
							datatype : "json",
			                height: 'auto',
			                autowidth: true,
			                ...
			                loadComplete: function() {
								var delSettings = {
				                    ...
				                    url:"ndr/sample/delemotiontitlesamplebyid",
				...
				function add(){
					$.ajax({
							url:"ndr/sample/addEmotionTitle?"+ $('#searchForm').serialize(),
							type:"GET",
							async:false,
