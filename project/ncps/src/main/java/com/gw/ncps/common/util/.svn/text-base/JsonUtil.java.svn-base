...
public class JsonUtil {
	...
	public static String toJson(final Object o)
	{
		...
		if (o instanceof ByteString){ //ByteString
			return byteString2Json((ByteString) o);
		}
	...
	/**
	 * 将 ByteString 对象编码为 JSON格式，只需处理好特殊字符
	 * 
	 */
	static String byteString2Json(final ByteString bs){
